...
const MeButton = () => {
  ...
  return (
    <div className="relative" data-testid="outside">
      <button data-testid="user-menu" data-id="dropdown" onClick={toggleMenu} className="w-full pb-[2px] pt-[4px] px-4 lg;px-12 lg:pb-0 lg:pt-[2px] lg:rounded flex flex-col items-center justify-center hover:bg-gray-100 outline-plum-600 outline-offset-[-2px] lg:outline-offset-[-1px]">
