...
const Nav = () => {
  ...
  return (
    <nav aria-label="Main menu" role="navigation" className="w-full lg:max-w-lg lg:justify-self-center flex items-center">
      <ul role="menubar" className="flex items-center justify-evenly">
        <li role="menuitem" >
          <Link to="/">
            <div className="py-0.5 px-4 hover:bg-gray-100 flex flex-col items-center justify-center">
        ...
        <li role="menuitem" className="lg:hidden">
          <Button design="none" onClick={logout} customStyles="py-0.5 px-4 hover:bg-gray-100 flex flex-col items-center justify-center">
