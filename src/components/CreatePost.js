      ...
      {nav ? (
        <button onClick={() => setShowModal(true)}>
          <div className="py-0.5 px-4 hover:bg-gray-100 flex flex-col items-center justify-center lg:rounded">
            <PlusIcon iconFill="#51557d" iconStyles="w-5 h-7 lg:w-7 lg:h-8"/>
        ...
        <div className="w-full rounded bg-white p-1 mb-6 flex flex-col items-center justify-center max-w-3xl lg:min-w-full shadow-sm">
          <button className="w-full px-3 py-2 bg-white rounded hover:bg-gray-100 active:bg-gray-200 flex items-center justify-start" onClick={() => setShowModal(true)}>
