...
const FriendCard = ({ friendData, type }) => {
  ...
  return (
    <div className="shadow-sm flex lg:flex-col bg-white w-full p-3 border-t lg:rounded lg:w-52 lg:m-4 lg:items-center lg:justify-center lg:p-0 lg:shadow-sm">
      ...
      <div className="flex flex-col justify-center w-full mb-1 lg:p-3 lg:items-center">
        <p className='font-bold text-md mb-2 lg:mb-3 lg:text-center whitespace-nowrap overflow-clip lg:max-w-[180px]'>{friendData.fullName}</p>
