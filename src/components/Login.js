...
<div className="items-center justify-center hidden lg:flex w-full -mr-12">
      ...
      <div className="flex flex-col items-center w-full lg:bg-transparent lg:mt-4 lg:pt-5 lg:pb-6 lg:max-w-lg">
        ...
        <Button type="submit" design="ghost" customStyles="font-semibold mt-3 max-w-sm">
